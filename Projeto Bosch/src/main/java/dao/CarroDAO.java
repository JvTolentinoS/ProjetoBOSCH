...
public class CarroDAO {
    public void salvar(Carro carro, Cliente cliente) {
        String sql = "INSERT INTO carro (carro_placa, carro_modelo, carro_marca, carro_ano, cpf, carro_defeito) VALUE (?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            pstm.setString(6, carro.getCarroDefeito());
    ...
    public void atualizar(Carro carro, Cliente cliente) {
        String sql = "UPDATE carro SET carro_placa = ?, carro_modelo = ?, carro_marca = ?, carro_ano = ?, carro_defeito = ? WHERE cpf = ?";
    ...
    public List<Carro> getCarros() {
        ...
        while (rset.next()) {
            ...
            carro.setCarroDefeito(rset.getString("carro_defeito"));
